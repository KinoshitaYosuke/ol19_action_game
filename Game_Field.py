...
def Make_Field(level):
    ...
    if level == 0:
        ...
        field = Make_Check_Field(field, 1050, 600, 1150, 700, (0, 0, 255))
        field = Make_Check_Field(field, 1350, 600, 1450, 700, (0, 0, 255))
        field = Make_Check_Field(field, 1650, 0, 1850, 550, (0, 0, 255))
        field = Make_Check_Field(field, 1650, 550, 1850, 600, (255, 0, 0))
        field = Make_Check_Field(field, 2000, 650, 2050, 700, (255, 0, 0))
        field = Make_Check_Field(field, 2250, 0, 2450, 550, (0, 0, 255))
        field = Make_Check_Field(field, 2250, 550, 2450, 600, (255, 0, 0))
        field = Make_Check_Field(field, 2600, 650, 2700, 700, (255, 0, 0))
        field = Make_Check_Field(field, 2850, 0, 2950, 550, (0, 0, 255))
        field = Make_Check_Field(field, 2850, 55, 2950, 600, (255, 0, 0))
        field = Make_Check_Field(field, 3150, 600, 3350, 700, (0, 0, 255))
        field = Make_Check_Field(field, 3350, 500, 3550, 700, (0, 0, 255))
        field = Make_Check_Field(field, 3550, 350, 3700, 700, (0, 0, 255))
    
    #Make_Check_Field(描画する変数, x座標始点, y座標始点, 幅, 高さ, 貼るテクスチャ)
        texture_field = Make_Texture(texture_field, 0, F_SIZE_Y - 50, F_SIZE_X, F_SIZE_Y, texture[2])
        texture_field = Make_Texture(texture_field, 1050, 600, 1150, 700, texture[7])
        texture_field = Make_Texture(texture_field, 1350, 600, 1450, 700, texture[7])
        texture_field = Make_Texture(texture_field, 1650, 0, 1850, 550, texture[0])
        texture_field = Make_Texture(texture_field, 1650, 550, 1850, 600, needle)
        texture_field = Make_Texture(texture_field, 2000, 650, 2050, 700, needle)
        texture_field = Make_Texture(texture_field, 2250, 0, 2450, 550, texture[0])
        texture_field = Make_Texture(texture_field, 2250, 550, 2450, 600, needle)
        texture_field = Make_Texture(texture_field, 2600, 650, 2700, 700, needle)
        texture_field = Make_Texture(texture_field, 2850, 0, 2950, 550, texture[0])
        texture_field = Make_Texture(texture_field, 2850, 550, 2950, 600, needle)
        texture_field = Make_Texture(texture_field, 3150, 600, 3350, 700, texture[1])
        texture_field = Make_Texture(texture_field, 3350, 500, 3550, 700, texture[1])
        texture_field = Make_Texture(texture_field, 3550, 350, 3700, 700, texture[1])
